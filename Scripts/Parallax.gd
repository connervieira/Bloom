...
func _process(delta):
	...
	self.get_child(0).position.y = CameraNode.position.y/4
	
	self.get_child(1).position.x = CameraNode.position.x/3
	self.get_child(1).position.y = CameraNode.position.y/9
	
	self.get_child(2).position.x = CameraNode.position.x/5
	self.get_child(2).position.y = CameraNode.position.y/25
	
	self.get_child(3).position.x = CameraNode.position.x/100
	self.get_child(3).position.y = CameraNode.position.y/1000
